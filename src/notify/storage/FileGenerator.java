...
/**
 * FileGenerator class is responsible for generating system folders: notify.config, data, commands
 * and generating system files: tasks(data) file, path file and 
 * various command(as of {@see notify.logic.command.Action}) files.
 */
public class FileGenerator {
	...
	/** 
	 * This class's Constructor which instantiate the files and folders that are to be generated.
	 * It then invokes {@link #generateConfigFolder() generateConfigFolder} method to create all the
	 * necessary folders. After which it invokes {@link #generateSystemFiles() generateSystemFiles}
	...
	/** 
	 * This method returns the File object which represents the notify.config folder 
	 * 
	...
	/** 
	 * This method returns the File object which represents the specified command file
	 * 
	 * @param command_		the Action object which corresponds to the command file
	 * 
	...
	/** 
	 * This method returns the contents of the specified command file as a String object
	 * 
	 * @param file_		the file to be read
	 * 
	 * @return the String object which represents the content of the first line in the 
	 * 			specified file
	 */
	...
	/** 
	 * This method generates the system files: data file, path file and various commands files.
	 * It invokes {@link #generateDirectoryFile() #generateDataFile() #generateCommandFiles()} methods
	 */
	...
	/**
	 * This method generate path file which is located inside the data folder
	 * If the path file does not exist, it creates new path file. 
	 * It then invokes {@link #writeIntoFile(File, String)} method to write the 
	 * default absolute path of the data file which is <tt>notify.config/data/</tt> into the path file
	 */
	...
	/**
	 * This method generate data file. It invokes {@link #readFromFile(File)} method to read the 
	 * content of the path file and retrieve it which represents the absolute path of the data file.
	 * It then creates a data file at the destination if it does not exist. 
	 * It invokes {@link #writeIntoFile(File, String)} method to write 
	 * {@value notify.storage.Constants#SQURE_BRACKETS} which represents the empty task list.
	 */
	...
	/**
	 * This method reads from the specified file.
	 * It then returns the content of the file.
	 */
